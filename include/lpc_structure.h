...
typedef struct {
        ...
        // Variable utilise par le simple Object memoire et celui de communication 
        ...
        //Utilise pour la communication inter processus 
        unsigned char libre;
        int return_v;
        int err;   
        
        // Information conserne les donne data
        char fun_name[NAMELEN];     
